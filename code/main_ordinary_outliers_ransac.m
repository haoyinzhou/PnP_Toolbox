...
pouts = [0.0:0.05:0.80];  % percentage of outliers
...
save ../results/ordinary3DresultsOutliersRansac method_list npt pouts prealout;

plotOrdinary3DoutliersRansac;

saveas(1, '../results/figure11(a).png');
saveas(3, '../results/figure11(b).png');
saveas(8, '../results/figure12.png');
